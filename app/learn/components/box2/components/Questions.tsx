...
export const question2: Question = {
    ...
    answer: "To gauge relative value. Investors us the P/E ratio to compare valuation of different stocks within the same industry against the market average. Warren Buffet famously said: It is far better to buy a wonderful company at a fair price than a fair company at a wonderful price."
}
...
export const question3: Question = {
    ...
    answer: "Nike has a typically than Amazon. Historically, Nike has maintained a more moderate valuation compared to Amazon due to differences in growth prospects, profit margins and market perception."
}
